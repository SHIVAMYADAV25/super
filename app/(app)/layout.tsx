...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    es.addEventListener("new_email", () => { queryClient.invalidateQueries({ queryKey: ["emails"] }); });
    es.addEventListener("new_event", () => { queryClient.invalidateQueries({ queryKey: ["events"] }); });
    return () => es.close();
  }, [queryClient]);
